...
This report uses the text from the short story "The Red Headed League" by Sir Arthur Conan Doyle to create a visualization of counts for the most frequently used words, finalized in a word cloud, and to perform sentiment analysis using the NRC Lexicon.
